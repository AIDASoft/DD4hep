...
#
cmd=['ddsim', '--compactFile', infileName, '--runType', 'run', '--enableG4Gun', '--action.step', 'Geant4MaterialScanner/MaterialScan', '-M', steerName ]
...
for line in result.stdout.splitlines():
    if 'Material scan between' in line:
        ...
        # print( iscan, iDir, startx, starty, startz )
        ...
        if iscan==nBins+1: # now move to the second set of scans
            ...
            iscan=1
        inScan=False
    elif '+-----------------' in line: # comment line
        continue
    elif '|     \   Material' in line: # comment line
        continue
    elif '| Num. \  Name' in line:     # comment line
        continue
    elif '| Layer \ ' in line:         # comment line
        continue
